...
if (isset($_POST['btn_upload']))
  {
    ...
    $stmt = $conn->prepare("INSERT INTO images (img_name, img_type, img_path, img_title) VALUES (:iname, :itype, :ipath, :ititle) ");
    ...
    if ($stmt->execute())
      {
        header('Location: upload.php?success=yes&title=' . $filetitle);
      }
    else
      {
        header('Location: upload.php?success=no');
      }
  }
?>
<html lang="en">
